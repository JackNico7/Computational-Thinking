 ...
 * Simulation Model
 ******************************************************************************/
sim.model.name = "02-PurchasingModel";
sim.model.title = "Purchasing Model (2)";
...
sim.model.shortDescription =
  "<p>The 02-PurchasingModel model implements a single Enterprise that produces and sells one single type of item and a single Consumer that purchases items from the Enterprise. On each day the Enterprise generates a <b>Produce event</b> to produce a finite quantity of items and the Consumer generates a <b>DecidePurchase event</b> that generates a <b>Purchase event</b> to order a specific quantity of items from the Enterprise. If the ordered quantity is in stock, the Enterprise delivers the quantity items to the Consumer and the order is fulfilled. Otherwise, the Enterprise delivers the quantity of items in stock to the Consumer (i.e., order is partially fulfilled) and registers the non-fulfilled quantity as lost sales.</p>";
sim.model.source = "";
